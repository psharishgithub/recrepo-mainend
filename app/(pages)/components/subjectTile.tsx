...
export default function SubjectTile({ name, code, regulation }: SubjectTileProps) {
  return (
    <Link href={`/landing/subject/${code}`} passHref>
      <Card className="bg-stone-900 border-transparent h-full w-full min-h-[200px] rounded-[20px] transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/10 hover:border-2 hover:border-white/50 flex flex-col">
